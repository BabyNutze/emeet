...
if ( isset( $_GET[ "a" ] ) && isset( $_GET[ "t" ] ) && isset( $_GET[ "atf" ] ) && isset( $_GET[ "atfno" ] ) ) {
	// Include config file
	$agenda_id = $_GET["a"];
	$tid = $_GET["t"];
	$atf = $_GET["atf"];
	...
	$sql = "DELETE FROM attachfiles WHERE agenda_id = " . $agenda_id . " and tid = " . $tid . " and atfid = "  . $atf . " and attach_no = "  . $atfno  ;
